...
//  Feudalism
//
//  Objekt Smočnica (Granary). Model u Core/Objects/Food/Granary/
//  Granary_Obj.obj, Granary_Mtl.mtl, Granary_Png.png
//
...
enum Granary: PlaceableSceneKitObject {
    ...
    static let modelAssetName = "Granary_Obj"
    static let textureAssetName = "Granary_Png"
    static let modelSubdirectory = "Core/Objects/Food/Granary"
    ...
    private static let textureSubdirectories: [String?] = [
        "Core/Objects/Food/Granary",
        "Food/Granary",
        "Granary",
        "Feudalism/Core/Objects/Food/Granary",
        nil,
    ]
    ...
    private static func loadTextureImage(bundle: Bundle = .main, objURL: URL? = nil) -> Any? {
        for sub in [modelSubdirectory, "Food/Granary", "Granary", nil] as [String?] {
            let url: URL? = sub != nil
