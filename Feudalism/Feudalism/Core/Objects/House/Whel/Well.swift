...
//  Feudalism
//
//  Objekt Zdenac (Well). Model u Core/Objects/House/Whel/
//  Whel_Obj.obj, Whel_Mtl.mtl, Whel_Png.png
//
...
/// Zdenac (well) – objekt koji se gradi na karti. Kategorija: dvorac (House button).
enum Well {
    static let objectId = "object_well"
    static let displayCode = "Z"

    static let modelAssetName = "Whel_Obj"
    static let textureAssetName = "Whel_Png"
    static let modelSubdirectory = "Core/Objects/House/Whel"
    ...
    static func modelURL(in bundle: Bundle = .main) -> URL? {
        ...
        return bundle.url(forResource: modelAssetName, withExtension: "obj", subdirectory: "House/Whel")
            ?? bundle.url(forResource: modelAssetName, withExtension: "obj", subdirectory: "Whel")
            ?? bundle.url(forResource: modelAssetName, withExtension: "obj")
    }

    private static let textureSubdirectories: [String?] = [
        "Core/Objects/House/Whel",
        "House/Whel",
        "Whel",
        "Feudalism/Core/Objects/House/Whel",
        nil,
    ]
    ...
    private static func loadTextureImage(bundle: Bundle = .main, objURL: URL? = nil) -> Any? {
        for sub in [modelSubdirectory, "House/Whel", "Whel", nil] as [String?] {
            let url: URL? = sub != nil
