...
//  Feudalism
//
//  Objekt Hotel. Model u Core/Objects/House/Hotel/
//  Hotel_Obj.obj, Hotel_Mdl.mtl, Hotel_Png.png
//
...
enum Hotel: PlaceableSceneKitObject {
    ...
    static let modelAssetName = "Hotel_Obj"
    static let textureAssetName = "Hotel_Png"
    static let modelSubdirectory = "Core/Objects/House/Hotel"
    ...
    static func modelURL(in bundle: Bundle = .main) -> URL? {
        ...
        return bundle.url(forResource: modelAssetName, withExtension: "obj", subdirectory: "House/Hotel")
            ?? bundle.url(forResource: modelAssetName, withExtension: "obj", subdirectory: "Hotel")
            ?? bundle.url(forResource: modelAssetName, withExtension: "obj")
    }

    private static let textureSubdirectories: [String?] = [
        "Core/Objects/House/Hotel",
        "House/Hotel",
        "Hotel",
        "Feudalism/Core/Objects/House/Hotel",
        nil,
    ]
    ...
    private static func loadTextureImage(bundle: Bundle = .main, objURL: URL? = nil) -> Any? {
        for sub in [modelSubdirectory, "House/Hotel", "Hotel", nil] as [String?] {
            let url: URL? = sub != nil
